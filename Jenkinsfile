    ...
    stage('Promote to Staging') {
      ...
      steps {
        ...
        container('kubectl'){
          ...
          sh "kubectl config --kubeconfig=config-demo set-context minikube --cluster=minikube --namespace=test-e2e --user=minikube"
          sh "kubectl config --kubeconfig=config-demo use-context minikube"
